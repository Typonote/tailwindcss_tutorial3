...
import HolidayImage from '../images/this_holiday_539.png'

const ThisHoliday = () => {
    return (
        <section className="hero this-holiday xl:mx-20">
            <div>
                <img className="hero-img" src={HolidayImage} alt="holiday pass" />
            </div>
    
            <div className="overlay bg-gray-800 text-center px-10 py-20 text-white">
